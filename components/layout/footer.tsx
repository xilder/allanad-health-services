...
const socialLinks = [
	...
	// { name: "LinkedIn", icon: Linkedin, href: "https://www.tiktok.com/@allanad.care?_r=1&_t=ZN-95PcM5gY26g" },
	{
		name: "Instagram",
		icon: Instagram,
		href: "https://www.instagram.com/allanadcare",
	},
];
			...
			<div className='container mx-auto px-4 py-12 lg:px-8 lg:py-16'>
				<div className='grid gap-8 lg:grid-cols-5'>
					...
					<div className='lg:col-span-2'>
						...
						<p className='mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground'>
							Compassionate healthcare services and digital health solutions
							designed to improve patient outcomes and empower individuals.
						</p>

						{/* Newsletter */}
						<div className='mt-6'>
							<p className='text-sm font-medium text-foreground'>
								Stay informed about health insights
							</p>
				...
				<div className='mt-12 flex flex-col gap-6 border-t border-border pt-8 lg:flex-row lg:items-center lg:justify-between'>
					<div className='flex flex-wrap gap-6 text-sm text-muted-foreground'>
						<a
							href='mailto:projects.allanad@proton.me'
				...
				<div className='mt-8 border-t border-border pt-8 text-center text-sm text-muted-foreground'>
					<p>
						&copy; {new Date().getFullYear()} Allanad Healthcare Alliance. All
						rights reserved.
					</p>
				</div>
			</div>
