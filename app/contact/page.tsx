...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with Allanad Healthcare Alliance. We're here to answer your questions about our healthcare services and partnership opportunities.",
}
      ...
      <Section className="bg-gradient-to-b from-muted/50 to-background">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-muted-foreground text-pretty">
            We would be happy to hear from you. Whether you have a question, want to schedule a consultation, or are interested in partnership opportunities, our team is ready to assist.
          </p>
        </div>
      </Section>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        For quick inquiries, you can reach us directly on WhatsApp. Our team will respond as soon as possible.
                      </p>
                      <Button
                        asChild
