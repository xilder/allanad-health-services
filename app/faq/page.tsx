...
export const metadata: Metadata = {
  ...
  description: "Find answers to common questions about Allanad Healthcare Alliance services, booking, and more.",
}
...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Our headquarters and main facilities are located in Lagos, Nigeria. We offer both in-person and virtual consultations to serve patients across the country.",
      },
      {
          ...
          <div className="space-y-12">
            {faqCategories.map((category) => (
              <div key={category.name}>
                <h2 className="mb-6 text-2xl font-semibold text-foreground">{category.name}</h2>
                <Accordion type="single" collapsible className="w-full space-y-2">
                  {category.questions.map((item, index) => (
                    <AccordionItem key={index} value={`${category.name}-${index}`} className="border border-border/50 rounded-lg px-4 bg-card">
      ...
      <Section className="bg-muted/30">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-center text-base text-muted-foreground">
            If you have a question that isn&apos;t answered here, please don&apos;t hesitate to reach out to our team. We&apos;re happy to help.
          </p>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-amber-800 dark:text-amber-200">
                Allanad Healthcare Alliance provides non-emergency healthcare services. In case of a medical emergency, please call emergency services (911, 999, or your local emergency number) immediately. Do not use this service for emergencies.
              </p>
            </div>
          </div>
        </div>
